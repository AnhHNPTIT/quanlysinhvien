...
if (isset($_GET['delete_sv'])) {
  ...
  $connection->query("delete from sinhvien where MaSV = '" . $delete_sv . "'");
  header("Location: index.php");
  $connection->query("delete from taikhoan where MaSV = '" . $delete_sv . "'");
  header("Location: index.php");
}
?>
<!DOCTYPE html>
            ...
            <tr>
              ...
              <td>
                <a href="show-sv.php?detail_sv=<?= $row['MaSV'] ?>" type="button"
                  ...
                  <a href="edit-sv.php?edit_sv=<?= $row['MaSV'] ?>" type="button" class="btn btn-warning btn-edit" title="Sửa"><i class="glyphicon glyphicon-edit"></i></a>
